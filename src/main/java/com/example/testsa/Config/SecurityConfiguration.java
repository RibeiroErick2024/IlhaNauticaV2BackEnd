...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/auth/login", "/auth/cadastro", "imagem/{id}", "imagem/", "/embarcacao/{id}", "/embarcacao/", "usuario/completarcadastro/{id}", "usuario/editar/{id}", "/endereco/", "/endereco/editar/{id}",  "/endereco/usuario", "/agendamento", "/agendamento/{id}", "/usuario/{id}", "/usuario/", "/marinheiro/{id}")
                .permitAll()
                .anyRequest()
                .authenticated()
                .and()
